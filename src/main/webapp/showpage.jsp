  ...
  <div>
    <form action="showpage.jsp" method="post">
      <div >
       ...
       <%--<img style=" vertical-align: middle" class="title" src="images/favicon.ico" alt="数据挖掘"/><span style="font-size: 22px;color: white;font-weight: bold">  贵阳市义务教育入学服务平台</span><span style="color: white;font-size: 16px;">|<c:out value="${title01}"/></span>--%>
